...
class MemoireEtConflits(unittest.TestCase):
    ...
    def test_l_alerte_de_conflit_ne_se_repete_pas_si_l_etat_oscille(self):
        """Le défaut qui s'est produit en production, et qui a rempli la
        conversation de centaines de messages identiques.
        ...
        for _ in range(20):
            ...
            t.conflit = False
            r._signaler_conflit()
        alertes = [e for e in t.envois if "refuse de me répondre" in e[0]]
...
class LimitesDeTelegram(unittest.TestCase):
    ...
    def test_seule_une_interrogation_reussie_leve_le_conflit(self):
        ...
        Un envoi réussi ne prouve rien sur l'interrogation : les deux robots
