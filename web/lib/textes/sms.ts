...
const en = {
  ...
  // La recherche vit derrière une icône de l'en-tête : elle a donc besoin de
  // ses deux verbes, que le champ permanent n'exigeait pas.
  ouvrirRecherche: "Search the messages",
  fermerRecherche: "Close the search",
  // La barre de filtres : le groupe, son compte annoncé, et les deux actions
  // du pied de la feuille.
  filtres: "Filters",
  filtresActifs: (n: number) => (n === 1 ? "1 filter on" : `${n} filters on`),
  effacerFiltres: "Clear",
  validerFiltres: "Done",
  fermerFiltreOperateur: "Close the operator filters",
  fermerFiltreCategorie: "Close the category filters",
...
const fr: typeof en = {
  ...
  ouvrirRecherche: "Rechercher dans les SMS",
  fermerRecherche: "Fermer la recherche",
  filtres: "Filtres",
  filtresActifs: (n) => (n > 1 ? `${n} filtres actifs` : `${n} filtre actif`),
  effacerFiltres: "Effacer",
  validerFiltres: "Valider",
  fermerFiltreOperateur: "Fermer les filtres d’opérateur",
  fermerFiltreCategorie: "Fermer les filtres de catégorie",
