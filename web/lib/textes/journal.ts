...
const en = {
  ...
  journal: {
    ...
    videDetail:
      "No door, no command, no session, no box has written a line yet. This register only ever grows — nothing is rewritten and nothing is deleted.",
    ...
    quiTitre: "Who",
    quiTous: "Anyone",
    commerceTitre: "Which shop",
    commerceTous: "Every shop",
    jourTitre: "Which day",
    jourTous: "Every day",
    effacerFiltres: "Show everything again",
    filtreExplique:
      "Three filters, and they add up: one person, one shop, one day. That is the question this screen is for — who did that, at whose counter, on which day.",
    ...
    boitiersEcartes:
      "What the boxes write about themselves is left out while a person is selected: nobody asked for it, so it does not answer the question.",
    plafond: (n: number) =>
...
const fr: typeof en = {
  ...
  journal: {
    ...
    videDetail:
      "Aucune porte, aucune commande, aucune session, aucun boîtier n'a encore écrit une ligne. Ce registre ne fait que grandir — rien n'y est réécrit, rien n'y est effacé.",
    ...
    quiTitre: "Qui",
    quiTous: "Tout le monde",
    commerceTitre: "Quel commerce",
    commerceTous: "Tous les commerces",
    jourTitre: "Quel jour",
    jourTous: "Tous les jours",
    effacerFiltres: "Tout réafficher",
    filtreExplique:
      "Trois filtres, et ils se cumulent : une personne, un commerce, un jour. C'est exactement la question que cet écran sert à poser — qui a fait cela, chez qui, quel jour.",
    ...
    boitiersEcartes:
      "Ce que les boîtiers écrivent sur eux-mêmes est laissé de côté tant qu'une personne est choisie : personne ne l'a demandé, cela ne répond donc pas à la question.",
    plafond: (n) =>
