...
const en = {
  ...
  // --- Écran 4 · les gens et les appareils -----------------------------------
  gens: {
    titre: "People & devices",
    ariane: (comptes: number, telephones: number) =>
      `${comptes} ${comptes === 1 ? "account" : "accounts"} · ${telephones} ${telephones === 1 ? "phone" : "phones"}`,
    videTitre: "No account on record",
    videDetail:
      "The database holds no account. Either it is unreachable, or this platform has never been signed up to — and you could not be reading this page.",
    mesureComptes: "Accounts",
    mesureEnAttente: "Awaiting approval",
    mesureEnAttenteCalme: "nobody is waiting at the door",
    mesureTelephones: "Phones notified",
    mesureFreins: "Addresses being slowed",
    mesureFreinsCalme: "nobody is hammering the door",
    comptesTitre: "Who can open this platform",
    comptesNote: "opened and closed in Settings → Who can sign in",
    colonneCourriel: "Account",
    colonneRole: "Role",
    colonneEtat: "Door",
    colonneEntree: "Last sign-in",
    role: { proprietaire: "owner", invite: "guest" },
    porteOuverte: "May sign in",
    porteFermee: "Held at the door",
    jamaisEntre: "has never signed in",
    creeLe: (d: string) => `created ${d}`,
    telephonesTitre: "The phones TOTEM rings",
    telephonesNote: "their push tokens stay in the database — no screen ever shows one",
    telephonesVideTitre: "No phone is registered for notifications",
    telephonesVideDetail:
      "A phone appears here on its own the first time the app registers for the payment ring.",
    sansNom: "unnamed device",
    colonneAppareil: "Device",
    ...
    colonneAdresse: "Address",
    colonneEssais: "Attempts",
    essais: (n: number) => `${n} ${n === 1 ? "attempt" : "attempts"}`,
    freinExplique:
      "The counter lives in the database, shared by every server. Five attempts are free; beyond that each one waits longer, and sixty shut the address out of the window entirely. The owner's own door never locks: the emergency key ignores the brake's wall.",
  },
};
...
const fr: typeof en = {
  ...
  nav: {
    ...
    gens: "Les gens et les appareils",
  ...
  gens: {
    titre: "Les gens et les appareils",
    ariane: (comptes, telephones) =>
      `${comptes} compte${comptes > 1 ? "s" : ""} · ${telephones} téléphone${telephones > 1 ? "s" : ""}`,
    videTitre: "Aucun compte au registre",
    videDetail:
      "La base ne porte aucun compte. Soit elle est injoignable, soit personne ne s'est jamais inscrit sur cette plateforme — et vous ne pourriez pas lire cette page.",
    mesureComptes: "Comptes",
    mesureEnAttente: "En attente d'approbation",
    mesureEnAttenteCalme: "personne n'attend à la porte",
    mesureTelephones: "Téléphones prévenus",
    mesureFreins: "Adresses ralenties",
    mesureFreinsCalme: "personne ne martèle la porte",
    comptesTitre: "Qui peut ouvrir cette plateforme",
    comptesNote: "s'ouvre et se ferme dans Réglages → Qui peut se connecter",
    colonneCourriel: "Compte",
    colonneRole: "Rôle",
    colonneEtat: "La porte",
    colonneEntree: "Dernière entrée",
    role: { proprietaire: "propriétaire", invite: "invité" },
    porteOuverte: "Peut entrer",
    porteFermee: "Retenu à la porte",
    jamaisEntre: "n'est jamais entré",
    creeLe: (d) => `créé le ${d}`,
    telephonesTitre: "Les téléphones que TOTEM fait sonner",
    telephonesNote:
      "leurs jetons de notification restent dans la base — aucun écran n'en montre jamais un",
    telephonesVideTitre: "Aucun téléphone n'est inscrit aux notifications",
    telephonesVideDetail:
      "Un téléphone apparaît ici tout seul, la première fois que l'application s'inscrit à la sonnerie des encaissements.",
    sansNom: "appareil sans nom",
    colonneAppareil: "Appareil",
    colonnePlateforme: "Système",
    ...
    colonneAdresse: "Adresse",
    colonneEssais: "Essais",
    essais: (n) => `${n} essai${n > 1 ? "s" : ""}`,
    freinExplique:
      "Le compteur vit dans la base, partagé par tous les serveurs. Cinq essais sont gratuits ; au-delà chacun attend plus longtemps, et soixante ferment l'adresse pour la fenêtre entière. La porte du propriétaire, elle, ne se verrouille jamais : la clé de secours ignore le mur du frein.",
  },
};
