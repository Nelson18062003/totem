...
import {
  IconBank, IconCard, IconChevron, IconGrid, IconInbox, IconList, IconRefresh,
} from "@/app/icons";
...
export type OngletConsole =
  | "flotte" | "cartes" | "clients" | "versions" | "journal" | "alertes";
...
// clients), puis ce qu'on a fait (versions, journal), puis ce qui crie.
const ONGLETS: readonly { cle: OngletConsole; href: string; Icone: typeof IconGrid }[] = [
  ...
  { cle: "clients", href: "/console/clients", Icone: IconBank },
