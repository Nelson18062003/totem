// Les marques OFFICIELLES des opérateurs, incorporées en SVG — jamais
// téléchargées à l'affichage. Le carré au mot blanc est le logo d'Orange tel
// que publié ; l'ovale au sigle est le logo MTN de 2022, trait pour trait
// (tracés relevés des fichiers officiels). Nets à 20 px, muets hors ligne.
//
// C'est de la DONNÉE, pas de la marque TOTEM : le logo dit « quelle caisse »,
// et il dit tout seul — aucun nom d'opérateur ne se répète à côté.

type P = { size?: number; className?: string };

/** Le logo officiel d'Orange — le carré, le mot en blanc. */
export function LogoOrange({ size = 24, className }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 283.5 283.5" className={className}
      style={{ borderRadius: 3 }} aria-hidden>
      <g>
...
export function LogoMtn({ size = 24, className }: P) {
  return (
    <svg width={size * 2} height={size} viewBox="-128 -64 1536 768" className={className} aria-hidden>
      <rect x="-128" y="-64" width="1536" height="768" rx="120" fill="#FFCB00" />
      <path d="M640,0C286.5,0,0,143.3,0,320s286.5,320,640,320s640-143.3,640-320S993.5,0,640,0z M640,589.5
		C314.4,589.5,50.5,468.8,50.5,320S314.4,50.5,640,50.5s589.5,120.7,589.5,269.5S965.6,589.5,640,589.5z M559.3,263.9v-50.5h180.5
		v50.5h-65v162.8h-50.5V263.9H559.3z M957.8,213.3v213.3h-50.5l-91.6-127v127h-50.5V213.3h50.5l91.6,127v-127L957.8,213.3z
		 M320.7,426.7V213.3h50.5l56.1,86.3l56.1-86.3H534v213.3h-50.5V306l-38.3,58.9h-35.6L371.2,306v120.7H320.7z" fill="#000000" />
    </svg>
  );
}

/** La puce neutre — l'opérateur n'est pas reconnu, on ne devine pas. */
export function LogoInconnu({ size = 24, className }: P) {
  return (
